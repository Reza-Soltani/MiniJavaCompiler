...
GRAMMAR = {
    ...
    17: "MethodDeclaration public static Type @set_local_search @identifier_method Identifier @add_row @start_scope @reset_local_search ( Parameters ) @reset_local_search @end_parameter { VarDeclarations Statements return GenExpression ; @end_scope }",
    18: "Parameters Type @set_local_search Identifier @identifier_parameter Parameter",
    19: "Parameters",
