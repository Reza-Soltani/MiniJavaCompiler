...
FIRST = {'Goal': ['public', 'class'], 'Source': ['public', 'class'], 'MainClass': ['public'], 'ClassDeclarations': ['class', ' '],
         'ClassDeclaration': ['class'], 'Extension': ['extends', ' '],
         'FieldDeclarations': [' ', 'static'], 'FieldDeclaration': ['static'], 'VarDeclarations': ['int', 'boolean', ' '],
         'VarDeclaration': ['int', 'boolean'], 'MethodDeclarations': ['public', ' '],
         'MethodDeclaration': ['public'], 'Parameters': ['boolean', 'int', ' '], 'Parameter': [',', ' '], 'Type': ['boolean', 'int'],
         ...
         'GenExpression': ['(', 'identifier', 'true', 'false', 'integer'], 'G': ['&&', ' '],
         'Expression': ['(', 'identifier', 'true', 'false', 'integer'], 'BB': ['+', '-', ' '], 'B': ['+', '-'],
         'Term': ['(', 'identifier', 'true', 'false', 'integer'], 'C': ['*', ' '], 'Factor': ['(', 'identifier', 'true', 'false', 'integer'],
         'D': ['.'], 'RelExpression': ['(', 'identifier', 'true', 'false', 'integer'], 'E': ['&&'],
         'RelTerm': ['(', 'identifier', 'true', 'false', 'integer'],
         'F': ['==', '<'], 'Arguments': ['(', 'identifier', 'true', 'false', 'integer', ' '], 'Argument': [',', ' '],
         'Identifier': ['identifier'], 'Integer': ['integer'], 'DD': ['(', ' ']}

FOLLOW = {'Goal': [''], 'Source': ['EOF'], 'MainClass': ['EOF'], 'ClassDeclarations': ['public'], 'ClassDeclaration': ['class', 'public'],
          'Extension': ['{'], 'FieldDeclarations': ['public', '}'], 'FieldDeclaration': ['static', 'public', '}'],
          ...
          'MethodDeclarations': ['}'], 'MethodDeclaration': ['public', '}'], 'Parameters': [')'],
            'Parameter': [')'], 'Type': ['identifier'], 'Statements': ['return', '}'], 'Statement': ['else'], 'A': ['return', '}'],
          'GenExpression': [';', ')'], 'G': [';', ')'], 'Expression': [';', ')', '&&'], 'BB': [';', ')', '&&'],
             'B': ['+', '-', ';', ')', '&&'], 'Term': ['+', '-', ';', ')', '&&'], 'C': ['+', '-', ';', ')', '&&'], 'Factor': ['+', '-', ';', ')', '&&'],
          'D': ['+', '-', ';', ')', '&&'], 'RelExpression': '', 'E': ['==', '<'], 'RelTerm': [';', '&&'], 'F': [';', '&&', ')'],
          'Arguments': [')'], 'Argument': [')'], 'DD': ['+', '-', ';', ')', '&&'],
          'Identifier': ['{', 'extends', 'static', 'public', '}', ';', '(', ',', ')', '=', '+=', '.', '+', '-', ';', ')', '&&'],
          'Integer': [';', ')', '+', '-', '&&']}