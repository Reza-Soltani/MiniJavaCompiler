...
GRAMMAR = {
    ...
    3: "MainClass public class #identifier_class #set_local_search Identifier #start_scope #reset_local_search { public static void main ( ) { VarDeclarations Statements } #end_scope }",
    4: "ClassDeclarations ClassDeclaration ClassDeclarations",
    5: "ClassDeclarations",
    6: "ClassDeclaration class #identifier_class #set_local_search Identifier #start_scope #reset_local_search Extension { FieldDeclarations MethodDeclarations #end_scope }",
    ...
    17: "MethodDeclaration public static Type #set_local_search Identifier #identifier_method #start_scope #reset_local_search ( Parameters ) #end_parametr { VarDeclarations Statements return GenExpression ; #end_scope }",
    18: "Parameters Type #set_local_search Identifier #identifier_parametr Parameter",
    19: "Parameters",
    20: "Parameter , Type Identifier #identifier_parametr Parameter",
    21: "Parameter",
    ...
    30: "Statement for ( #Pid #Pid Identifier = #Int Integer #Assign ; RelTerm #Cmp_save ; #Pid Identifier +=  #Int Integer ) Statement #For",
    ...
    47: "Factor Integer",
    48: "D",
    49: "D #identifier_name . Identifier #aggregate DD",
    50: "DD",
    51: "DD ( Arguments )",  # TODO: support this!
    52: "RelExpression RelTerm E",
    53: "E",
    54: "E && RelTerm E",
    55: "RelTerm Expression F",
    56: "F == Expression #Check_equal",
    57: "F < Expression #Check_less",
