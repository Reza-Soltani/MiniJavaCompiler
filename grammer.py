...
GRAMMAR = {
    ...
    17: "MethodDeclaration public static Type @set_local_search @identifier_method Identifier @add_row @start_scope @reset_local_search ( Parameters ) #get_current_line @end_parameter { VarDeclarations Statements return GenExpression @return_assign #return_assign ; @end_scope }",
    ...
    30: "Statement for ( Identifier = Integer @assign #assign ; #label RelTerm #save ; Identifier += Integer ) Statement #plus_assign #end_for",
    31: "Statement Identifier = GenExpression @assign #assign ;",
    ...
    36: "BB B BB",
    37: "BB",
    38: "B + Term @not_bool_add @assign #plus_operation",
    39: "B - Term @not_bool_minus @assign #minus_operation",
    40: "Term Factor C",
    41: "C * Factor @not_bool_mult @assign #multi_operation C",
    42: "C",
    ...
    50: "DD",
    51: "DD ( Arguments ) @call_method #call_method",
    52: "RelExpression RelTerm E",
    53: "E",
    54: "E && RelTerm @not_int_and #and_operation E",
    55: "RelTerm Expression F",
    56: "F == Expression @assign #rel_equal",
    57: "F < Expression @not_bool_less @assign #rel_less",
