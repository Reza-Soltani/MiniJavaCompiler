...
GRAMMAR = {
    ...
    17: "MethodDeclaration public static Type @set_local_search @identifier_method Identifier @add_row @start_scope @reset_local_search ( Parameters ) @end_parameter { VarDeclarations Statements return GenExpression #return_assign ; @end_scope }",
